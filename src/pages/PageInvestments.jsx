  ...
  const openEdit = r => {
    setModal({
      ...
      data: {
        ...
        lag_enabled: r.payment_lag_config?.enabled != null ? !!r.payment_lag_config.enabled : false,
        lag_type: r.payment_lag_config?.enabled != null ? (r.payment_lag_config.type || "Days") : "Days",
        lag_value: r.payment_lag_config?.enabled != null ? (r.payment_lag_config.value || 0) : 0,
