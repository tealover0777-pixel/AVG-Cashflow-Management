...
export default function PageReports({ t, isDark, MONTHLY = [], activeTenantId = "" }) {
  ...
  return (<>
    ...
    {tab === "Analytics" && (
      <div style={{ background: t.surface, borderRadius: 16, border: `1px solid ${t.surfaceBorder}`, padding: 0, height: "calc(100vh - 340px)", minHeight: 650, display: "flex", flexDirection: "column", overflow: "auto" }}>
        <iframe
          key={lookerUrl}
          src={lookerUrl}
