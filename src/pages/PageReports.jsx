...
export default function PageReports({ t, isDark, MONTHLY = [], activeTenantId = "" }) {
  ...
  return (<>
    ...
    {tab === "Analytics" && (
      <div style={{ background: t.surface, borderRadius: 0, border: `1px solid ${t.surfaceBorder}`, padding: 0, height: "calc(100vh - 380px)", minHeight: 500, display: "flex", flexDirection: "column", overflow: "hidden", marginBottom: 20 }}>
        <iframe
          key={lookerUrl}
          src={lookerUrl}
