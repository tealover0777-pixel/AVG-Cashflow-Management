...
export default function PageReports({ t, isDark, MONTHLY = [], activeTenantId = "" }) {
  ...
  return (<>
    ...
    {tab === "Analytics" && (
      <div style={{ background: t.surface, borderRadius: 16, border: `1px solid ${t.surfaceBorder}`, padding: "0", height: "calc(100vh - 320px)", minHeight: 650, display: "flex", flexDirection: "column", overflowX: "hidden" }}>
        <iframe
          key={lookerUrl}
          src={lookerUrl}
