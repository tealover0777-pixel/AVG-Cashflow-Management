...
function PageContracts({ t, isDark, CONTRACTS = [], PROJECTS = [], PARTIES = [] }) {
  ...
  const cols = [{ l: "", w: "40px" }, { l: "ID", w: "80px" }, { l: "PROJECT ID", w: "85px" }, { l: "PROJECT", w: "minmax(0,1fr)" }, { l: "PARTY", w: "minmax(0,1fr)" }, { l: "TYPE", w: "90px" }, { l: "AMOUNT", w: "110px" }, { l: "RATE", w: "70px" }, { l: "FREQ", w: "90px" }, { l: "TERM", w: "60px" }, { l: "CALCULATOR", w: "120px" }, { l: "START", w: "95px" }, { l: "MATURITY", w: "95px" }, { l: "STATUS", w: "80px" }, { l: "CREATED", w: "95px" }, { l: "UPDATED", w: "95px" }, { l: "ACTIONS", w: "80px" }];
