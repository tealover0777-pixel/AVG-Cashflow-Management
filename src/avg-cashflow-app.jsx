...
const hybridDays = (startDate, quarterEnd) => {
...
const pmtCalculator_ACT360_30360 = (periodStart, periodEnd, investDate, investAmount, interestRate, frequency) => {
